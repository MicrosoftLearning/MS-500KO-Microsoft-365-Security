...
This repo was replaced by a [new repo](https://github.com/MicrosoftLearning/MS-500-Microsoft-365-Security.ko-kr) on December 18th 2021. We're making this change to improve the localized version of this content and reduce the delta between English and localized content updates. 
After a short interval, this repo will be archived.

**Contributions**

At this time, we are not accepting external contributions to this repo. If you have suggestions or spot any errors, please create a pull request or report an issue on the [new repo](https://github.com/MicrosoftLearning/MS-500-Microsoft-365-Security.ko-kr).

# MS-500X: Microsoft 365 보안 관리자

이 리포지토리에는 다음 과정용 랩 지침이 포함되어 있습니다.

- MS-500T00: Microsoft 365 보안 관리
